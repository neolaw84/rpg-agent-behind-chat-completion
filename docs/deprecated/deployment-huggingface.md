...
4. *(Optional)* Set a custom password for your proxy: Add a second secret named **`RACHEL_PROXY_KEY`** and set the value to a password of your choice (like `my-rpg-password`). If you don't set this, the system will generate a random one for you.
...
If you didn't set a custom `RACHEL_PROXY_KEY` in Step 2, you need to find the password the system generated for you:
